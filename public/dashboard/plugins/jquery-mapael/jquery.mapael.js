...
(function (factory) {
    ...
    Mapael.prototype = {
         ...
         *   - Set the container admin to the way it was before mapael instanciation
            ...
            var computeNextStep = function () {
                ...
                if (elapsed < durationWithMargin) {
                    ...
                    if (zoomDir === 'in' && (w > self.currentViewBox.w || w < targetW)) {
                        ...
                        // Otherwise, the user would see the camera going admin and forth
